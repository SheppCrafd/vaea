...
export default function SettingsPage() {
  ...
  return (
    <div className="h-full flex overflow-hidden gap-3 px-3 pb-3">
      {isSidebarOpen && (
        <aside className="dark text-foreground w-56 shrink-0 overflow-hidden rounded-2xl bg-[linear-gradient(180deg,#181818_0%,#111111_55%,#0C0C0C_100%)] shadow-xl flex flex-col">
