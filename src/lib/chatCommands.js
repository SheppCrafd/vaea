...
export const CHAT_COMMANDS = [
  ...
  { name: "vault-log", description: "Log this session to your connected Vaea Brain" },
  { name: "vault-tidy", description: "Audit your connected Vaea Brain's wikilinks and propose fixes" },
  ...
  { name: "focus-vault", description: "Answer only from your Vaea Brain notes, no web or workspace data" },
