...
const store = createDeviceKeyStore("vaea_chat_reflection_prefs", DEFAULTS);

export const loadReflectionPreferences = store.load;
export const saveReflectionPreferences = store.save;
